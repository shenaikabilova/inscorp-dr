						...
						<div class="form-row">
							<div class="form-row-inner">
								...
								<select id="vehicleEngine" class="field" name="vehicleEngine">
									<option <%if(i.getVehicleEngine() == 1.4) { %> selected <% }%> >1.4</option>
									<option <%if(i.getVehicleEngine() == 1.6) { %> selected <% }%> >1.6</option>
									<option <%if(i.getVehicleEngine() == 1.8) { %> selected <% }%> >1.8</option>
									<option <%if(i.getVehicleEngine() == 2.0) { %> selected <% }%> >2.0</option>
								</select>
							</div>
							<div class="form-row-inner">
								<label>Брой места</label>
								<select id="vehiclePlaces" class="field" name="vehiclePlaces">
									<option <%if(i.getVehiclePlaceNumber() == 2 ) { %> selected <% }%> >2</option>
									<option <%if(i.getVehiclePlaceNumber() == 3 ) { %> selected <% }%> >3</option>
