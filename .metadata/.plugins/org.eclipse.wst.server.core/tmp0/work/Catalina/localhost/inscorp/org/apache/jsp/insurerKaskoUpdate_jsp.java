 ...
 * Generated at: 2016-06-30 18:27:18 UTC
...
public final class insurerKaskoUpdate_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	try {
      ...
      out.write("\t\t\t\t<h3>Редакция на застраховка \"Каско\"</h3>\r\n");
      out.write("\t\t\t\t<form action=\"kaskoUpdate\" method=\"post\">\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\t");
 List<Kasko> list = (List<Kasko>)request.getAttribute("result");
      ...
      out.write(" name=\"insurenceID\" placeholder=\"№ на застраховка\" size=\"30\" maxlength=\"6\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-section\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"text\" id=\"EGN\" class=\"field\" value=");
      out.print(i.getInsurenceEGN() );
      out.write(" name=\"EGN\" placeholder=\"ЕГН\" size=\"30\" maxlength=\"10\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-row\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<select id=\"vehicleType\" class=\"field\" name=\"vehicleType\">\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write(" name=\"vehicleFirstReg\" placeholder=\"Дата на първа регистрация\" id=\"datepicker\" size=\"30\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-row-inner\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<option ");
if(i.getVehicleEngine() == 1.4) { 
      out.write(" selected ");
 }
      out.write(" >1.4</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option ");
if(i.getVehicleEngine() == 1.6) { 
      out.write(" selected ");
 }
      out.write(" >1.6</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option ");
if(i.getVehicleEngine() == 1.8) { 
      out.write(" selected ");
 }
      out.write(" >1.8</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option ");
if(i.getVehicleEngine() == 2.0) { 
      out.write(" selected ");
 }
      out.write(" >2.0</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-row-inner\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<option ");
if(i.getVehiclePlaceNumber() == 2 ) { 
      out.write(" selected ");
 }
      out.write(" >2</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option ");
if(i.getVehiclePlaceNumber() == 3 ) { 
      out.write(" selected ");
 }
      out.write(" >3</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option ");
if(i.getVehiclePlaceNumber() == 4 ) { 
      out.write(" selected ");
 }
      out.write(" >4</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option ");
if(i.getVehiclePlaceNumber() == 50) { 
      out.write(" selected ");
 }
      out.write(" >50</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      ...
      out.write(" id=\"datepicker1\" name=\"fromDate\">\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-row-inner\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label>Край</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"field\" type=\"text\" value=");
      out.print(i.getInsurenceDateTo());
      out.write(" id=\"datepicker2\" name=\"toDate\">\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-row\">\r\n");
      ...
      out.write(" id=\"vehicleInsValue\" name=\"vehicleInsValue\" size=\"30\" value=\"0\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-row\">\r\n");
      out.write("\t\t\t\t\t\t\t<label>Застрахователна премия</label>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" class=\"field\" value=");
      out.print(i.getVehicleInsurencePremiq() );
      out.write(" id=\"vehicleInsPremiq\" name=\"vehicleInsPremiq\" size=\"30\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<input type=\"submit\" value=\"Промени\" name=\"kaskoUpdate\">\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t");
 } 
      out.write("\r\n");
