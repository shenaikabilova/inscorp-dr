 ...
 * Generated at: 2016-06-30 19:56:45 UTC
...
public final class searchInsKaskoByID_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<div class=\"searchGO\">\r\n");
      out.write("\t\t\t<div class=\"shell\">\r\n");
      out.write("\t\t\t\t<form action=\"searchKaskoByID\" method=\"get\">\r\n");
      out.write("\t\t\t\t<h3>Търсене на застраховка \"Каско\" по № на полица</h3>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"submit\" value=\"Намери\" name=\"searchKaskoByID\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\t\t\t\t\r\n");
      out.write("\t\t\t\t</form>\t\r\n");
      out.write("\t\t\t</div>\r\n");
