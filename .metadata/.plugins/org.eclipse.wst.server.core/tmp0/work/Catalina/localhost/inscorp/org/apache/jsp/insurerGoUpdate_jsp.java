 ...
 * Generated at: 2016-06-27 16:56:50 UTC
...
public final class insurerGoUpdate_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t<script src=\"js/GO/calendarGO.js\"></script>\r\n");
      out.write("\t\t<script src=\"js/GO/setKubici.js\"></script>\r\n");
      out.write("\t\t<script src=\"js/GO/setGOValue.js\"></script>\r\n");
      out.write("\t\t<script src=\"js/validate.js\"></script>\r\n");
      out.write("\t\t<script src=\"js/GO/onLoad.js\"></script>\r\n");
      out.write("\t</head>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\t<h3>Редакция на застраховка \"Гражданеска отговорност\"</h3>\r\n");
      out.write("\t\t\t\t<form action=\"GoUpdate\" method=\"post\">\r\n");
      out.write("\t\t\t\t");
      ...
      out.print(i.getInsurenceGrajdanskaOtgovornostID() );
      out.write(" name=\"policaN\" maxlength=\"6\">\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-row\">\r\n");
      ...
      out.write(" name=\"insuredFirstName\" placeholder=\"Име\" size=\"30\" maxlength=\"50\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"field\" value=");
      out.print(i.getInsurenceSecondName() );
      out.write(" name=\"insuredSecondName\" placeholder=\"Презиме\" size=\"30\" maxlength=\"50\"> \r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"field\" value=");
      out.print(i.getInsurenceLastName() );
      out.write(" name=\"insuredLastName\" placeholder=\"Фамилия\" size=\"30\" maxlength=\"50\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label>ЕГН</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"field\" value=");
      out.print(i.getInsurenceEGN() );
      out.write(" name=\"EGN\" placeholder=\"ЕГН\" maxlength=\"10\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label>Държава</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<select class=\"field\" name=\"country\">\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write(" name=\"address\" placeholder=\"гр. ж.к. ул. бл. вх. ет. ап.\" size=\"50\" maxlength=\"200\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-row-inner\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"pKod\">Пощенски код</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"field\" value=");
      out.print(i.getInsurencePK() );
      out.write(" name=\"pKod\" placeholder=\"Пощенски код\" size=\"20\" maxlength=\"4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-row\">\r\n");
      ...
      out.write(" name=\"mobilePhone\" placeholder=\"Мобилен телефон\" size=\"30\" maxlength=\"10\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"registrationNumber\" class=\"field\" value=");
      out.print(i.getVehicleRegNumber() );
      out.write(" name=\"registrationNumber\" placeholder=\"Регистрационен №\" size=\"20\" onchange=\"isValidRegNumber();\" maxlength=\"8\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-row-inner\">\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t>Зона IІ - Пловдив, Варна и Бургас</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t>Зона ІІІ - Други</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      ...
      out.write(" name=\"ramaN\" placeholder=\"Рама №\" size=\"30\" maxlength=\"17\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-row\">\r\n");
      ...
      out.write(" name=\"vehicleModel\" placeholder=\"Модел\" size=\"30\" maxlength=\"50\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-row\">\r\n");
      ...
      out.write(" placeholder=\"Начална дата\" id=\"datepicker1\" name=\"fromDate\">\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-row-inner\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label>Край</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"field\" type=\"text\" value=");
      out.print(i.getInsurenceDateTo() );
      out.write(" placeholder=\"Крайна датва\" id=\"datepicker2\" name=\"toDate\">\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-row\">\r\n");
      ...
      out.print(i.getInsurenceValue() );
      out.write(" id=\"vehicleInsValue\" name=\"vehicleInsValue\" size=\"30\" readonly=\"readonly\" >\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("<!-- \t\t\t\t\t\t<div class=\"form-row\"> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t<label>Отстъпки</label> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t<input  -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\tonchange=\"setGOPremiq();\" onkeypress=\"onchange();\" onpaste=\"this.onchange();\" oninput=\"onchange();\" -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\tclass=\"field\" id=\"insOtstapki\" type=\"text\" name=\"insOtstapki\" value=\"0\"> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t</div> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t<div class=\"form-row\"> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t<label>Надбавки</label> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t<input -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\tonchange=\"setGOPremiq();\" onkeypress=\"onchange();\" onpaste=\"this.onchange();\" oninput=\"onchange();\" -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\tclass=\"field\" id=insNadbavki type=\"text\" name=\"insNadbavki\" value=\"0\"> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t</div> -->\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-row\">\r\n");
      out.write("\t\t\t\t\t\t\t<label>Застрахователна премия</label>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"field\" value=");
      out.print(i.getInsurencePremiq() );
      out.write("  id=\"insPremiq\" type=\"text\" name=\"insPremiq\" readonly=\"readonly\" >\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<input type=\"submit\" value=\"Сключи застраховка\" name=\"GoUpdate\">\r\n");
      out.write("\t\t\t\t");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t</form>\r\n");
