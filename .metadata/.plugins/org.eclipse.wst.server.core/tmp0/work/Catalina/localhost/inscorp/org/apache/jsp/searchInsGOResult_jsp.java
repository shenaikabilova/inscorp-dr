 ...
 * Generated at: 2016-06-30 19:58:45 UTC
...
public final class searchInsGOResult_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<h3>Застраховка \"Гражданска отговорност\" по № на полица</h3>\r\n");
      out.write("\t\t\t<table border=\"1\">\r\n");
      out.write("\t\t\t\t<th>Застраховател</th> \r\n");
      out.write("\t\t\t\t<th>№ на полица</th>\r\n");
      out.write("\t\t\t\t<th>Тип на застрахован</th>\r\n");
      out.write("\t\t\t\t<th>Име</th> \r\n");
      ...
      out.write("\t\t\t\t<th>Вид МПС</th>\r\n");
      out.write("\t\t\t\t<th>РАМА</th> \r\n");
      out.write("\t\t\t\t<th>Марка</th>\r\n");
      out.write("\t\t\t\t<th>Модел</th>\r\n");
      out.write("\t\t\t\t<th>Застраховка - от дата</th>\r\n");
      out.write("\t\t\t\t<th>Застраховка - до дата</th> \r\n");
      out.write("\t\t\t\t<th>Месеци</th>\r\n");
      out.write("\t\t\t\t<th>Застрахователна сума</th>\r\n");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurerID());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurenceGrajdanskaOtgovornostID());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurenceType());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurenceFirstName());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurenceSecondName());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurenceLastName());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurenceEGN());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurenceCountry());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurenceAddress());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurencePK());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurenceMobilePhone());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getVehicleRegNumber());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getZone());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getVehicleType());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getVehicleRama());
      out.write("</td> \r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getVehicleBrand());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getVehicleModel());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurenceDateFrom());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurenceDateTo());
      out.write("</td> \r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurenceMonths());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurenceValue());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(go.getInsurencePremiq());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\t");
