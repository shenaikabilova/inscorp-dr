...
/**
 * Servlet for update existing insurance kasko
 * @author shenaikabilova
 *
 */
@SuppressWarnings("serial")
@WebServlet("/kaskoUpdate")
public class KaskoUpdate extends HttpServlet {
	/** 
	...
	/** 
	 * Post method for updating existing kasko by specific ID
