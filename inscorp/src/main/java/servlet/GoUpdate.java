...
/**
 * Servlet for updating existing insurance grajdanska otgovorstno by specific ID
...
public class GoUpdate extends HttpServlet {
	...
	/**
	 * Post method for updating existing insurance grajdanska otgovornost by specific ID
...
request.setCharacterEncoding("UTF-8");
		...
		go.updateGO(new GrajdanskaOtgovornost(insurerID, insurenceGrajdanskaOtgovornostID, 
